...
var Mean = require('../models/mean.model')
...
exports.getTodos = async function(query, page, limit){
    ...
    try {
        var todos = await Mean.paginate(query, options)
...
exports.updateTodo = async function(todo){
    ...
    try{
        ...
        var oldTodo = await Mean.findById(id);
    }catch(e){
...
exports.deleteTodo = async function(id){    
    // Delete the Todo
    try{
        var deleted = await Mean.deleteOne({_id: id})
