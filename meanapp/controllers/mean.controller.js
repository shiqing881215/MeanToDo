...
var MeanService = require('../services/mean.service')
...
exports.getTodos = async function(req, res, next){
    ...
    try{  
        ...
        var todos = await MeanService.getTodos({}, page, limit)
...
exports.createTodo = async function(req, res, next){
    ...
    try{
        ...
        var createdTodo = await MeanService.createTodo(todo)
...
exports.updateTodo = async function(req, res, next){
    ...
    try{
        var updatedTodo = await MeanService.updateTodo(todo)
...
exports.removeTodo = async function(req, res, next){
    ...
    try{
        var deleted = await MeanService.deleteTodo(id)
